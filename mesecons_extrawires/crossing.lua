for x=-1, 1 do for z=-1, 1 do
	...
	minetest.register_node(nodename, {
		...
		tiles = {
			"jeija_dioded_wire_top.png",
			"jeija_dioded_wire_bottom.png",
			"jeija_dioded_wire_C.png",
			"jeija_dioded_wire_A.png",
			"jeija_dioded_wire_B.png",
			"jeija_dioded_wire_D.png",
		},
		paramtype = "light",
		walkable = false,
		stack_max = 99,
		...
		node_box = {
			...
			fixed = {
				...
				{ -3/32, -13/32, -8/32, 3/32, -6/32, -6/32 },
				{ -3/32, -8/32, -8/32, 3/32, -6/32, 8/32 },
				{ -3/32, -13/32, 6/32, 3/32, -6/32, 8/32 },
